...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/axisregistry-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/axisregistry-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add axisregistry
# for installing globally
pixi global install axisregistry
```
...
It is possible to list all of the versions of `axisregistry` available on your platform:
...
```
pixi search axisregistry --channel conda-forge
```
